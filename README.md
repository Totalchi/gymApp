...
2. Open de **SQL Editor** en voer [`supabase/migrations/0001_init.sql`](supabase/migrations/0001_init.sql) uit.
   Dit maakt alle tabellen + Row Level Security policies aan.
...
src/
  app/
    ...
    routines/[id]/          Schema-builder
    exercises/              Oefeningen-bibliotheek
  components/               UI-componenten (builder, picker, rijen)
  lib/
    rir.ts                  RIR-berekening (+ tests)
    types.ts                Gedeelde types
    supabase/               Supabase-clients (browser/server/middleware)
supabase/
  migrations/0001_init.sql  Database-schema + RLS
